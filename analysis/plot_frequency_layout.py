...
from src.model.laser_beams import get_frequencies
...
detunings = [0]
transitions = [
    {'ground': 3, 'excited': 0}, # F = 2 -> F' = 1
    {'ground': 2, 'excited': 0}, # F = 1+ -> F' = 1
    {'ground': 1, 'excited': 0}, # F = 0 -> F' = 1
    {'ground': 0, 'excited': 0}, # F = 1- -> F' = 1
]
...
for saturation in saturations:
    for detuning in detunings:
        freqs = get_frequencies(transitions, E_X, E_A, 0) * molecule.line_width_in_MHz
